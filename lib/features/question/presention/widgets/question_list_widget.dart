...
class QuestionListWidget extends StatelessWidget {
   ...
   const QuestionListWidget({Key? key,required this.questions}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListView.separated(itemBuilder: (context,index){
      return ListTile(
        ...
        onTap: (){
          Navigator.push(context,MaterialPageRoute(builder: (_)=>QuestionDetailScreen(question: questions[index],)));
        },
      );
    },
